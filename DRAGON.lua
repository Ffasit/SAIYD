...
if res ~= 200 then
print('\27[0;31m◤━───━ 𝙎𝘼𝙄𝘿𝘼 ━───━◥\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na◤━───━ 𝙎𝘼𝙄𝘿𝘼 ━───━◥\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m◤━───━ 𝙎𝘼𝙄𝘿𝘼 ━───━◥ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/SAIYD/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1770621216,1653985520,1631066082,1832404948}   
...
var = true 
elseif tonumber(user_id) == tonumber(1653985520) then
var = true  
elseif tonumber(user_id) == tonumber(1832404948) then
var = true 
elseif tonumber(user_id) == tonumber(1631066082) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐨𝐮𝐬𝐜𝐞")  
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/SAIYD/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'♝ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♝ اصدار سورس الصعيدي { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/sourceJa"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❪تـواصل السـورس❫', url="t.me/reacksi"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_,0," ♝ العضو : {["..data.first_name_.."](T.ME/sourceJa)}\n ♝ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♝ عذرا ⇎ {["..data.first_name_.."](T.ME/sourceJa)}\n ♝ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
♝‍♂️آهّـلَآ بًيَکْ فُيَ سِـوٌرسِ↯آلَعٌـآلَمًـيَ↯آلَآعٌـظُمً  ♝‍♀️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❪جـابـوا⒈❫',url="t.me/J_a_b_w_a"},{text = '❪بـنـزيـن⒉❫', url="t.me/zznnmb"}},
{{text = '❪سـامـح⒊❫',url="t.me/Shhcx"}}, 
{{text = '❪قـنـاه الـسـورس❫ ', url="t.me/sourceJa"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourceJa&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❪جـابـوا❫',url="t.me/J_a_b_w_a"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourceJa/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'باندا'  then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❪بـنـزيـن❫ ',url="t.me/D_vban"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourceJa/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'سامح'  then
local Text = [[
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourceJa/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الصعيدي ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الصعيدي ؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[
 مبرمج باندا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/yhu79/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب الصعيدي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♝ اهلا في قائمه الالعاب المتطوره سورس الصعيدي  ♝ 
...
elseif text == 'قفل الصعيديرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♝ بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ♝ تـم قفـل الصعيديرسيه ')
end,nil)   
...
elseif text == 'فتح الصعيديرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fars'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♝ بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ♝ تـم فـتح الصعيديرسيه ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1631066082) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1653985520) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1832404948) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1631066082) then
send(msg.chat_id_, msg.id_, " ♝ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1653985520) then
send(msg.chat_id_, msg.id_, " ♝ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1832404948) then
send(msg.chat_id_, msg.id_, " ♝ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1631066082) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1653985520) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1832404948) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/SAIYD/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♝ اهلا بك في متجر ملفات الصعيدي\n ♝ ملفات السورس ↓\n◤━───━ 𝙎𝘼𝙄𝘿𝘼 ━───━◥\n\n"
local TextE = "\n◤━───━ 𝙎𝘼𝙄𝘿𝘼 ━───━◥\n ♝ علامة تعني { ✔️ } ملف مفعل\n ♝ علامة تعني { ✖ } ملف معطل\n ♝ قناة سورس الصعيدي ↓\n".." ♝ [اضغط هنا لدخول](t.me/sourceJa) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/SAIYD/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ♝ عذرا الملف لايدعم سورس الصعيدي \n") 
end
return false
end
...
if text and text:match("^رفع الصعيدي @(.*)$") and Sudo(msg) then
local username = text:match("^رفع الصعيدي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع الصعيدي (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع الصعيدي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الصعيدي @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل الصعيدي @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل الصعيدي (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل الصعيدي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
end --الكود حصري سورس الصعيدي يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/sourceJa)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/sourceJa)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/sourceJa)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/sourceJa)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/sourceJa)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/sourceJa)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/sourceJa)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/sourceJa)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/sourceJa)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/sourceJa)') 
return false
end
end
end
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝖺𝗂𝖽𝖺 ⇣', url="t.me/sourceJa"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
